...
To better understand the data we collected, we created a Shiny dashboard, where a user can explore the activity timeline of a repository conveniently. If time permits, we may add aggregated measurements onto the dashboard,too.
